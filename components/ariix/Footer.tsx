      ...
      <footer>
        <div className="footer-grid">
          ...
          <div className="footer-col">
            ...
            <ul>
              <li><Link href="/best-skin-care-clinic-in-pune/">Home</Link></li>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 text-[13px] text-[var(--grey)] leading-[1.6]">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-between items-start">
              <div className="flex-1 min-w-[200px]">
                ...
                <a href="tel:+917447424939" className="hover:underline font-semibold text-white/95">📞 +91 74474 24939</a>
              </div>
        ...
        <div className="footer-bottom !flex !flex-col sm:!flex-row !justify-center sm:!justify-between !items-center text-center gap-2 sm:gap-0 w-full">
          <p>© 2026 Ariix Hair and Skin Clinic. All rights reserved.</p>
          <p>Developed with <span className="text-red-500">❤️</span> by <a href="https://wa.me/919284394722" target="_blank" rel="noopener noreferrer" className="hover:underline text-[var(--purple-light)] font-semibold transition-colors">QuantumReach</a></p>
        </div>
      </footer>
    </>
  );
